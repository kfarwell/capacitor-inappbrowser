...
| **`enableReloadGesture`**              | <code>boolean</code>                                                                                                                                                   | Enable pull-to-refresh (overscroll from top) to reload the current page. - iOS: Uses UIRefreshControl on the WebView scroll view - Android: Uses SwipeRefreshLayout around the WebView On iOS, this requires overscroll bounce. If `disableOverscroll` is `true`, the reload gesture will not work.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | <code>true</code>                                             | 8.10.8 |
